...
export const transactionSchema = yup.object(
    {
        ...
        toAcc: yup.string("Account no format is all decimal with 10 length").required("Receiver is required").test("Digits only", "This field should have only decimals with length of 10.", digitsOnly).length(10),
